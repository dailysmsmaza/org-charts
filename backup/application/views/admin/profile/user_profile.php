  ...
  <div class="clshiddenconsec">
   <div class="maincontainer">
    <div class="pageconent">
        <div class="pageconentbx clsusrdetailpg">
				...
				<?php } ?>	
                  ...
                  <div class=""></div>
                    <table  class="mobiletable userslist-table">            
                    		<tr>	                            
	                            <td colspan="2" align="center" class="clsusrimage">
	                            	<img src="<?php echo ($user_profile["user_image"]!="") ? base_url('assets/userimage/'.$user_profile["user_image"]) : base_url('assets/images/user_demo.png')?>" class="rounded" style="height:200px;"></td>
	                        </tr>
	                        <tr>
	                            <th>Role</th>
