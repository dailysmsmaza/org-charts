    ...
    if ($_FILES["file"]["size"] > 0) {
        ...
        while (($column = fgetcsv($file, 10000, ",")) !== FALSE) {
            ...
            if($cnt){
                ...
                //echo $company;exit();
                $role = 3;
                $data = array('role' => $role, 'company' => $company, 'first_name' => $first_name, 'last_name' => $last_name,  'email' => $email, 'phone' => $phone, 'designation' => $designation, 'about' => $about, 'skill' => $skill, 'city' => $city ,'password' => md5($password));
            //    echo "dasda";exit;
