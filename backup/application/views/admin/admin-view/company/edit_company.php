                ...
                <div class="formwraper">
                    <form method="post" action="<?php echo base_url('company/edit/'.$edit_company['id']) ?>"  name="user_form" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9 col-lg-9 col-xl-10"><input type="text" name="first_name" id="first_name" value="<?php echo (set_value('first_name'))?set_value('first_name'):$edit_company['first_name'] ?>" class="form-control"><label class="error" for="first_name"></label></div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9 col-lg-9 col-xl-10"><input type="text" name="email" id="email" value="<?php echo (set_value('email'))?set_value('email'):$edit_company['email'] ?>" class="form-control"><label class="error" for="email"></label></div>
                        </div>
                         <div class="form-group row">
