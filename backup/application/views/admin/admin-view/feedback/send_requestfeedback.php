                ...
                <div class="formwraper">
                    <form method="post" action=""  name="sendrequest_form" enctype="multipart/form-data">
                          <div class="form-group row">
                            ...
                            <select class="select2 form-control" id="employee_id" name="employee_id" required="required">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9 col-lg-9 col-xl-10">
                                 <input type="text" name="reqfd_subject" id="reqfd_subject" required="required" class="form-control" value="">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-3 col-lg-3 col-xl-2">Message</label>
                            <div class="col-md-9 col-lg-9 col-xl-10">
                                <textarea name="reqfd_message" cols="35" rows="5" class="form-control"></textarea>
