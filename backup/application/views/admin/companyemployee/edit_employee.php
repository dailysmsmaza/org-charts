                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9 col-lg-9 col-xl-10">
                                <select name="parent_employee" class="select2 form-control" id="parent_employee">
                                    ...
                                    $query = $this->db->query("SELECT * FROM user_master WHERE ceo = 0 AND status = 1 AND is_delete = 0 AND company = ".$edit_employee['company']." AND id != ".$edit_employee['id'].$departmentcond." or (ceo=1 and company=".$edit_employee['company'].") ORDER BY ceo DESC,first_name ASC, last_name ASC");
                                    if($query->num_rows()){
                                        foreach ($query->result() as $user) {  
                                            if($user->ceo==1){
                                                     ?>
