...
(function (factory) {
  ...
  OrgChart.prototype = {
    ...
    attachExportButton: function () {
      ...
      // var $exportBtn1 = $('<button>', {
      //   'class': 'oc-export-btn shart-chart' + (this.options.chartClass !== '' ? ' ' + this.options.chartClass : ''),
      //   'text': 'Share Chart',
      //   'click': function(e) {
      //     e.preventDefault();
      //     that.exportshare();
     ...
     // this.$chartContainer.append($exportBtn1);
    },
    ...
    exportPDF: function(canvas, exportFilename){
      ...
      //doc.addImage(canvas.toDataURL("assets/images"), 'png', 50, 40);
       doc.addImage(canvas.toDataURL(),"png",50,50);
    //window.location=doc.output("datauristring");
      //doc.addImage(canvas.toDataURL('data:image/png;base64,iVBORw0KGgoAA..'),'png', 15, 40, 0, 0);
    ...
    // exportshare: function (exportFilename, exportFileextension) {
    //   //alert("here");
    // }
  };
