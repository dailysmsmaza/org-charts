<div class="m-subheader ">
  <div class="d-flex align-items-center">
    ...
    <a href="<?php echo base_url('admin/category/create'); ?>" class="btn btn-success m-btn m-btn--icon text-capitalize"> <span> <i class="fa fa-plus-circle"></i><span></span>Add Category</span> </a></div>
</div>
<div class="col-sm-12">
    ...
    <table id="gridTable" class="table table-striped m-table ">
      <thead>
        <tr class="p-0 ">
          ...
          <th width="35%" class="py-3">Category Name</th>
          <th width="20%" class="py-3">Application Name</th>
          <th width="15%" class="py-3">Application Id</th>
...
<input type="hidden" name="message" value="Application has been updated successfully.">
<input type="hidden" name="data_table" value="application">
