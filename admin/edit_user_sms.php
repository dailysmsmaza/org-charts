...
<ul class="w3-ul w3-card-4">
	...
	<div class="well well-sm"> <center> Add User SMS </center> </div>
	...
	<div class="container">
		...
		<div class="form-group">
			...
			<div class="col-sm-7">
				<input type="text" class="form-control" name="username" value="<?php echo $user_id_name?>"/>
			 </div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-7">
				<textarea class="form-control" rows="4" name="sms"><?php echo $user_message_id_sms; ?></textarea>
			 </div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-7">
				<input type="text" class="form-control" id="tags" name="cat_name"  value="<?php echo $cat_id_name;	?>, "/>
			 </div>
		</div>
