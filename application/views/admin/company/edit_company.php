        ...
        <div class="pageconentbx">
            ...
            <div class="whitebox">
                <div class="formwraper">
                    <form method="post" action="<?php echo base_url('company/edit/'.$edit_company['id']) ?>"  name="user_form" enctype="multipart/form-data">
                        <div class="form-group row">
                            <label class="col-md-3 col-lg-3 col-xl-2">User Image</label>
                            <div class="col-md-9 col-lg-9 col-xl-10 fileprevwrap">
                                <input type="file" name="user_image" class="form-control">
                                <input type="hidden" name="old_user_image" value="<?php echo $edit_company['user_image'] ?>">
                                <label class="error" for="user_image"></label>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-3 col-lg-3 col-xl-2">First Name</label>
                            <div class="col-md-9 col-lg-9 col-xl-10"><input type="text" name="first_name" id="first_name" value="<?php echo (set_value('first_name'))?set_value('first_name'):$edit_document['first_name'] ?>" class="form-control"><label class="error" for="first_name"></label></div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-3 col-lg-3 col-xl-2">Last Name</label>
                            <div class="col-md-9 col-lg-9 col-xl-10"><input type="text" name="last_name" id="last_name" value="<?php echo (set_value('last_name'))?set_value('last_name'):$edit_company['last_name'] ?>" class="form-control"><label class="error" for="last_name"></label></div>
                        </div>                   
                        <div class="form-group row">
                            <label class="col-md-3 col-lg-3 col-xl-2">Email</label>
                            <div class="col-md-9 col-lg-9 col-xl-10"><input type="text" name="email" id="email" value="<?php echo (set_value('email'))?set_value('email'):$edit_document['email'] ?>" class="form-control"><label class="error" for="email"></label></div>
                        </div>
                         <div class="form-group row">
                            <label class="col-md-3 col-lg-3 col-xl-2">Password</label>
                            <div class="col-md-9 col-lg-9 col-xl-10"><input type="password" name="password" value="<?=set_value('password');?>" id="password" class="form-control"><label class="error" for="password"></label></div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-3 col-lg-3 col-xl-2">Phone</label>
                            <div class="col-md-9 col-lg-9 col-xl-10"><input type="text" name="phone" id="phone" value="<?php echo (set_value('phone'))?set_value('phone'):$edit_company['phone'] ?>" class="form-control"><label class="error" for="phone"></label></div>
                        </div>
                        <!-- <div class="form-group row">
                            <label class="col-md-3 col-lg-3 col-xl-2">Designation</label>
                            <div class="col-md-9 col-lg-9 col-xl-10">
                                <input type="text" name="designation" value="<?php echo $edit_company['designation'] ?>" class="form-control">
                            </div>
                        </div> -->
                        <div class="form-group row">
                            <label class="col-md-3 col-lg-3 col-xl-2">About</label>
                            <div class="col-md-9 col-lg-9 col-xl-10">
                                <textarea name="about" cols="35" rows="5" class="form-control"><?php echo (set_value('about'))?set_value('about'):$edit_company['about'] ?></textarea>
                            </div>
                        </div>
                        <!-- <div class="form-group row">
                            <label class="col-md-3 col-lg-3 col-xl-2">Skill</label>
                            <div class="col-md-9 col-lg-9 col-xl-10">
                                <input type="text" name="skill" value="<?php echo $edit_company['skill'] ?>" class="form-control">
                            </div>
                        </div> -->
                        <div class="form-group row">
                            <label class="col-md-3 col-lg-3 col-xl-2">Address</label>
                            <div class="col-md-9 col-lg-9 col-xl-10">
                                <textarea name="city" id="city" class="form-control"><?php echo (set_value('city'))?set_value('city'):$edit_company['city'] ?></textarea><label class="error" for="city"></label>
                            </div>
                        </div>                
                        <div class="form-group row">
                            <input type="submit" id="add_company" value="Update Company">
                        </div>                              
                </form>
            </div>
            </div>    
