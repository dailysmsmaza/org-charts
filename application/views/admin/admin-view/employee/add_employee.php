        ...
        <div class="pageconentbx">
            ...
            <div class="whitebox">
                ...
                <div class="formwraper">
                    <form method="post" action="<?php //echo base_url('employee/add_employee') ?>"  name="employee_form" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9 col-lg-9 col-xl-10"><input type="file" name="user_image"></div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9 col-lg-9 col-xl-10"><input type="password" name="password" class="form-control" value="<?=set_value('password');?>"></div>
                            </div>              
                            
                            <div class="form-group row">
                                <label class="col-md-3 col-lg-3 col-xl-2">Phone</label>
                                <div class="col-md-9 col-lg-9 col-xl-10"><input type="text" name="phone" id="phone" class="form-control" value="<?=set_value('phone');?>"></div>
                            </div>
                            <div class="form-group row">
                                                ...
                                                $subquery = $this->db->query("SELECT * FROM department_master WHERE status = 1 AND parent_id='".$user->id."' AND company_id = ".$companyid." ORDER BY parent_id ASC");
                                                 if($subquery->num_rows()){
                                                    foreach ($subquery->result() as $subteam) { ?>
                                                        <option value="<?=$subteam->id;?>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?=$subteam->name;?></option><?php
                                                       }
                                                }
                                            }
                                       } 
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9 col-lg-9 col-xl-10">
                                    <select class="select2 form-control" name="parent_employee" id="parent_employee">
                                        ...
                                        $query = $this->db->query("SELECT * FROM user_master WHERE ceo = 0 AND status = 1 AND is_delete = 0 AND company = ".$companyid." ORDER BY first_name ASC, last_name ASC");
                                        if($query->num_rows()){
                                            foreach ($query->result() as $user) { ?>
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-md-9 col-lg-9 col-xl-10">
                                   <select class="select2 form-control" name="access_level" id="access_level">      <option value="0">Basic</option>
                                         <option value="1">Advacnced</option>
                                         <option value="2">Administrater</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group row">
