    ...
    <div class="pageconent">
        <div class="pageconentbx">
            ...
            <div class="whitebox">
                ...
                <form method="post" action="<?php //echo base_url('employee/edit/' . $edit_employee['id']) ?>"  name="user_form" enctype="multipart/form-data">
                    <div class="form-group row">                        
                            <label class="col-md-3 col-lg-3 col-xl-2">Company</label>
                            <div class="col-md-9 col-lg-9 col-xl-10">
                                    <?php 
                                        //$companyid = $this->session->userdata("id");
                                        $companyid = $edit_employee['company'];
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9 col-lg-9 col-xl-10"><input type="text" id="phone" name="phone" value="<?php echo (set_value('phone'))?set_value('phone'):$edit_employee['phone'] ?>" class="form-control"></div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-lg-3 col-xl-2">Department</label>
                            <div class="col-md-9 col-lg-9 col-xl-10">
                                <select class="select2 form-control" name="department_id" id="department_id">
                                    <option value="">Select Department</option><?php
                                    $query = $this->db->query("SELECT * FROM department_master WHERE status = 1 AND company_id = ".$edit_employee['company']." ORDER BY name ASC");
                                    if($query->num_rows()){
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9 col-lg-9 col-xl-10">
                                <select name="parent_employee" class="select2 form-control" id="parent_employee">
                                    <option value="">Select Line manager</option><?php
                                    ...
                                    $query = $this->db->query("SELECT * FROM user_master WHERE ceo = 0 AND status = 1 AND is_delete = 0 AND company = ".$edit_employee['company']." AND id != ".$edit_employee['id'].$departmentcond." ORDER BY first_name ASC, last_name ASC");
                                    if($query->num_rows()){
                                        foreach ($query->result() as $user) { ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9 col-lg-9 col-xl-10">
                                <input type="text" name="start_date" class="form-control datepicker" value="<?php echo (set_value('start_date'))?set_value('start_date'):date('d-m-Y', strtotime($edit_employee['start_date'])); ?>">
                            </div>
                        </div>
                           <div class="form-group row">
                                ...
                                <div class="col-md-9 col-lg-9 col-xl-10">
                                   <select class="select2 form-control" name="access_level" id="access_level">   <option value="0" <?php if($edit_employee['access_level']=='0'){ echo set_select('access_level', "0",TRUE); }?>>Basic</option>
                                        <option value="1" <?php if($edit_employee['access_level']=='1'){ echo set_select('access_level', "1", TRUE); } ?>>Advanced</option>
                                        <option value="2" <?php if($edit_employee['access_level']=='2'){ echo set_select('access_level', "2", TRUE); } ?>>Administrater</option>
                                    </select>
                                </div>
                            </div>
                        <div class="form-group row">
