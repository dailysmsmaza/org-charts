        ...
        <div class="pageconentbx">
            ...
            <div class="whitebox">
                <div class="formwraper">                                            
                    <form method="post" action="<?php echo base_url('user/add_user') ?>"  name="user_form" enctype="multipart/form-data">
                        <!--    <div class="form-group row">
                            <label class="col-md-3 col-lg-3 col-xl-2">Role</label>
                                <div class="col-md-9 col-lg-9 col-xl-10">
                                    <select name="role" class="form-control">
                                        <option selected="" disabled="">Select Role</option>
                                        <option value="1" <?php //echo set_select('role', "1", False); ?>>Admin</option>                                        
                                    </select>
                                </div>
                        </div> -->                        	
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9 col-lg-9 col-xl-10"><input type="text"  class="form-control" name="first_name"  id="first_name" value="<?php echo set_value('first_name'); ?>">
                                <label class="error" for="first_name"></label>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-3 col-lg-3 col-xl-2">Last Name</label>
                            <div class="col-md-9 col-lg-9 col-xl-10"><input type="text" name="last_name" id="last_name" value="<?php echo set_value('last_name'); ?>" class="form-control">
                            <label class="error" for="last_name"></label></div>
                        </div>
                           
                        <div class="form-group row">
                            <label class="col-md-3 col-lg-3 col-xl-2">Email</label>
                            <div class="col-md-9 col-lg-9 col-xl-10"><input type="text" name="email" id="email" value="<?php echo set_value('email'); ?>" class="form-control">
                            <label class="error" for="email"></label></div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-3 col-lg-3 col-xl-2">Password</label>
                            <div class="col-md-9 col-lg-9 col-xl-10"><input type="password" name="password" id="password" class="form-control" value="<?php echo set_value('password'); ?>" onkeypress="return AvoidSpace(event);">
                            <label class="error" for="password"></label></div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-3 col-lg-3 col-xl-2">Confirm Password</label>
                            <div class="col-md-9 col-lg-9 col-xl-10"><input type="password" name="confirmpassword" id="confirmpassword" class="form-control" value="<?php echo set_value('password'); ?>" onkeypress="return AvoidSpace(event);">
                            <label class="error" for="confirmpassword"></label></div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-3 col-lg-3 col-xl-2">Phone</label>
                            <div class="col-md-9 col-lg-9 col-xl-10"><input type="text" maxlength="12" id="phone" name="phone" class="form-control phone" value="<?php echo set_value('phone'); ?>" onkeyup="phonenumber_validation(phone.value)">
                            <label class="error" for="phone"></label></div>
                        </div>
                       <!--  <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9 col-lg-9 col-xl-10">
                                <textarea name="about" id="about"  class="form-control"><?php echo set_value('about'); ?></textarea>
                            </div>
                        </div>
                       <!--  <div class="form-group row">
                        ...
                        <div class="form-group row">
                            <input  type="submit" name="add_company" id="add_company" value="Add User">
                        </div>			                        
                    </form>
                </div>
            </div>    
...
<script type="text/javascript">
    ...
    function phonenumber_validation(b)   
      {  
        var a = /(^[0-9]+[-]*[0-9]+$)/;  
        if (a.test(b) == true){  
            ...
            console.log("Please Enter Only Digits & Hyphen.")  
        }  
     };
