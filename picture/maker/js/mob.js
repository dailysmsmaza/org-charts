$(function () {
    ...
    var canvas = new fabric.Canvas('canvas-mob1');
    var canvas2 = new fabric.Canvas('canvas-mob2');
    var ctx = canvas.getContext("2d");
    var ctx2 = canvas2.getContext("2d");
    var data = 'images/default.jpg';
    if (quote != "") {
        var xhr = new XMLHttpRequest();
        xhr.open("GET", quote.image_url, true);
    ...
    $(document).on('click', '#download', function () {
        ...
        var width;
        var height;
        var can3 = document.getElementById('canvas-mob3');
        var can1 = document.getElementById('canvas-mob1');
        var can2 = document.getElementById('canvas-mob2');
        ...
        ctx3.drawImage(can1, 0, 0, can1.width, can1.height,     // source rectangle
            0, 0, can3.width, can3.height);
        ctx3.drawImage(can2, 0, 0, can2.width, can2.height,     // source rectangle
            0, 0, can3.width, can3.height);
