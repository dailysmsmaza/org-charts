...
<ul class="w3-ul w3-card-6">
	...
	<form class="form-horizontal" role="form" name="f1" method="post" accept-charset="utf-8" enctype="multipart/form-data">
		...
		<div class="form-group">
			...
			<div class="col-sm-7">
				<textarea id="smsarea" name="sms"></textarea>
			</div>
		</div>
...
<?php
	...
	if(isset($_POST["submit"]))
	{
			...
			while($user_data = mysqli_fetch_array($user_info))
			{
				...
				$user_name = $user_data["username"];
					...
					foreach($cat_id as $sms_sub_cat_id)
					{
						...
						$get_all_id = getParentID($sms_sub_cat_id);
			...
			{	
				...
				<script>
					window.location = "<?php echo $adminurl; ?>/home.php?id=<?php echo $id; ?>";
				</script>
				<?php
			...
			if($location=="last")
			{
				...
				<script>
					window.location = "<?php echo $adminurl; ?>/last.php";
				</script>
				<?php
				//header("location:$adminurl/last.php");
			}
