    ...
    <div class="m-portlet__body pb-2">
      ...
      <div class="form-group m-form__group row">
        ...
        <div class="col-lg-4 col-md-9 col-sm-12">
          <input type="text" class="form-control input-lg m-input" id="category_name" name="category_name"  value="<?php echo get_input('category_name', $cat->category_name); ?>" required data-msg-required="Please enter category name.">
        </div>
      </div>
      		...
      		<select  class="form-control input-lg m-input" name="app_id" id="app_id"  required data-msg-required="Please select app.">
                ...
                <?php
                            foreach ($appname as $key => $val) {
                                ?>
                                <option <?php echo ($cat->app_id == $val['app_id']) ? 'selected' : ''; ?>  value="<?php echo $val['app_id']; ?>"><?php echo $val['app_name']; ?></option>
                                <?php
                            }
                            ?>
            </select>
     ...
     <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-9 col-md-12 col-sm-12">
                        ...
                        <?php if ($cat->category_image != ""): ?>
                            <div class="w-25 mt-2">
                                <img class="image-admin-display w-100" src="<?php echo base_url($cat->category_image); ?>">
                            </div>
                        <?php endif; ?>
                    </div>
                </div>         
